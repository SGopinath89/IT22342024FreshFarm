...
router.post('/forgotpassword', async (req, res) => {
  ...
  try {
    ...
    var transporter = nodemailer.createTransport({
      service: 'gmail',
      auth: {
        user: 'rashmikanaveen222@gmail.com',
        pass: 'apxs kcvx dvvz rnyg'
      }
    });

    var mailOptions = {
      from: 'rashmikanaveen222@gmail.com',
      to: `${email}`,
      subject: 'Reset password - farm food system',
...
router.post('/forgotpassword/:token', async (req, res) => {
  ...
  try {
    ...
    // Update user's password with plain text password
